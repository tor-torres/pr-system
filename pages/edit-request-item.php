            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post">
                                <input type="hidden" name="action" value="update_requested_item">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-lg-6">
                                            <?php
                                                $category = '';
                                                $query = $DB->query(" SELECT * FROM itemtable INNER JOIN categorytable ON itemtable.cat_id = categorytable.cat_id ");
                                            ?>
